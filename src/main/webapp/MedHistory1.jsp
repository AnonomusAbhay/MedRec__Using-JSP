...
<body>
  ...
  %>
<input type="hidden" value="<%=session.getAttribute("id")%>" id="userid" name="userid">
    <!-- NAVBAR -->
...
try{
  ...
  String qry="SELECT * FROM `medhistory` where `patientId`='"+session.getAttribute("id")+"' ";
    ...
    overflow-y: scroll;">
      ...
      <!--  -->
          ...
          <div class="floating-btn">
            ...
            <!--   <button id="open" class="btn btn-primary" onclick="show()">➕Add Medical Parameter</button> -->
            <input id="open" class="btn btn-primary"  onclick="show()" type="button" value="➕Generate QR">
          </div> 
         ...
         <div id="myModal" class="modal"> 
            ...
            <div class="modal-content">
              <div class="modal-heading">
                <h3 class="QRtitle">Medical History QR</h3>
                <div class="close">&times;</div>
              </div>
              <div class="modal-container">
                   <div class="QRBox">
                    <img class="qrimg" src="" alt="" id="qrmed" srcset="">
                   </div> 
  ...
  <script>
     let QRBox=document.getElementById("QRBox");
      ...
      let serverurl="http://localhost:8082/MedRec1/patientmedicalgettopost.jsp?uid=" ;
      function generateQR()
      {
